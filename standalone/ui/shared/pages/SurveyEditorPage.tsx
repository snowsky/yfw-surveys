...
const s: Record<string, React.CSSProperties> = {
  ...
  qCard: { border: "1px solid #e5e7eb", borderRadius: 8, padding: 14, marginBottom: 10 },
};

interface DraftQuestion extends QuestionCreate {
  _id?: string; // existing question id
}
...
export default function SurveyEditorPage() {
  ...
  return (
    <div style={s.page}>
      ...
      {questions.length === 0 && (
        <p style={{ color: "#6b7280", fontSize: 14 }}>No questions yet. Add one to get started.</p>
      )}
